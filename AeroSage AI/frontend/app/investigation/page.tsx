...
import { Plane, ImageIcon, AlertTriangle, ArrowLeft } from "lucide-react";
        ...
        {result.status === "success" && (
          <>
            ...
            <p className="mt-10 text-center text-xs text-muted">
              Retrieved from FAA Documentation, Incident Reports — Powered by Actian
              VectorAI, EmbeddingGemma, Qwen3-Reranker, RoBERTa-SQuAD2
            </p>
